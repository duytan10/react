  ...
  return ReactDOM.createPortal(
    ...
    >
      <div
        ...
        onClick={handleClose}
      ></div>
      <div className="modal-content relative z-10 w-full p-10 max-w-[428px] bg-white rounded-lg">
        <span
          className="absolute top-0 right-0 flex items-center justify-center w-10 h-10 p-1 translate-x-1/2 -translate-y-1/2 bg-white rounded-full cursor-pointer border border-[#E7ECF3]"
          onClick={handleClose}
        >
          <svg
            width="14"
